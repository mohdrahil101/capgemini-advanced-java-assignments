...
//		double highestSalary=employees.stream().mapToDouble(e->e.getSalary()).max().orElse(0.0);
        ...
        itExperiencedEmployees.forEach((e)->System.out.println(e.getName()));
